...
\begin{cventries}
  \cventry
    ...
    {Bexio AG} % Organization
    {Rapperswil, CH} % Location
    {Apr. 2022 - PRESENT} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
      	\item{Lead SRE, Quality and Architecture Teams}
      	\item{Responsible for Platform Architecture (concepts and planning)}
        \item {Planning product roadmap together with the CTO}
      \end{cvitems}
    }
